    ...
    public partial class CreateIdentitySchema : Migration
    {
            ...
            MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(
                        nullable: false),
                    Name =
                        table.Column<string>(maxLength: 256,
                            nullable: true),
                    NormalizedName =
                        table.Column<string>(maxLength: 256,
                            nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetRoles",
                        x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUsers",
                        x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetRoleClaims",
                        x => x.Id);
                    table.ForeignKey(
                        name:
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserClaims",
                        x => x.Id);
                    table.ForeignKey(
                        name:
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Enrollment",
                        x => x.EnrollmentId);
                    table.ForeignKey(
                        name: "FK_Course",
                        column: x => x.CourseId,
